<?php $__env->startSection('title', 'Изменить сотрудника'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="patronymic" class="form-control" value="<?php echo e(old('patronymic', $employee->patronymic)); ?>">
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="store_id" class="form-select">
                        ...
                        <option value="<?php echo e($s->id); ?>" <?php if(old('store_id', $employee->store_id) == $s->id): echo 'selected'; endif; ?>><?php echo e($s->name); ?></option>
            ...
            <div class="form-check mb-0">
                ...
                <input type="checkbox" name="is_active" value="1" class="form-check-input" id="is_active" <?php if(old('is_active', $employee->is_active)): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/pawn-shop-mvp/resources/views/employees/edit.blade.php ENDPATH**/ ?>