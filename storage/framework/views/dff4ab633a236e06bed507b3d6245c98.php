<?php $__env->startSection('title', 'Приём товара'); ?>
...
<form method="post" action="<?php echo e(route('accept.store')); ?>" enctype="multipart/form-data" id="accept-form">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="visit_purpose" id="visit_purpose_value" value="<?php echo e(old('visit_purpose', 'appraisal')); ?>">
                    ...
                    <ol class="mb-0">
                        ...
                        <li class="mb-3">
                            ...
                            <select id="visit_purpose" class="form-select" required aria-label="Цель визита">
                                <?php $__currentLoopData = \App\Models\ClientVisit::purposeLabels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php echo e(old('visit_purpose', 'appraisal') === $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select name="contract_type" class="form-select" id="contract_type" required>
                            <option value="pawn" <?php echo e(old('contract_type') === 'pawn' ? 'selected' : ''); ?>>Залог</option>
                            <option value="commission" <?php echo e(old('contract_type') === 'commission' ? 'selected' : ''); ?>>Комиссия</option>
                            <option value="purchase" <?php echo e(old('contract_type') === 'purchase' ? 'selected' : ''); ?>>Скупка</option>
                        </select>
                    </div>
                    <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="client_phone" id="client_phone" class="form-control" value="<?php echo e(old('client_phone')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="client_last_name" id="client_last_name" class="form-control" value="<?php echo e(old('client_last_name')); ?>" placeholder="Заполняется по фото или вручную">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Имя *</label>
                            <input type="text" name="client_first_name" id="client_first_name" class="form-control" value="<?php echo e(old('client_first_name')); ?>" placeholder="Заполняется по фото или вручную">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Отчество</label>
                            <input type="text" name="client_patronymic" id="client_patronymic" class="form-control" value="<?php echo e(old('client_patronymic')); ?>" placeholder="Опционально">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Дата рождения</label>
                            <input type="text" name="client_birth_date" id="client_birth_date" class="form-control" value="<?php echo e(old('client_birth_date')); ?>" placeholder="ДД.ММ.ГГГГ" autocomplete="off">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Серия и номер паспорта</label>
                            <input type="text" name="client_passport_series_number" id="client_passport_series_number" class="form-control" value="<?php echo e(old('client_passport_series_number')); ?>" placeholder="12 34 567890">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label">Кем выдан</label>
                            <input type="text" name="client_passport_issued_by" id="client_passport_issued_by" class="form-control" value="<?php echo e(old('client_passport_issued_by')); ?>" placeholder="Орган, выдавший паспорт">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Когда выдан</label>
                            <input type="text" name="client_passport_issued_at" id="client_passport_issued_at" class="form-control" value="<?php echo e(old('client_passport_issued_at')); ?>" placeholder="ДД.ММ.ГГГГ" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Паспортные данные (полный текст)</label>
                        <textarea name="client_passport" id="client_passport" class="form-control" rows="3" placeholder="Серия, номер, кем и когда выдан, регистрация…"><?php echo e(old('client_passport')); ?></textarea>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="item_name" id="item_name" class="form-control" value="<?php echo e(old('item_name')); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Описание</label>
                        <textarea name="item_description" id="item_description" class="form-control" rows="2"><?php echo e(old('item_description')); ?></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="storage_location_id" class="form-select" id="storage_location_id">
                                <option value="">—</option>
                                <?php $__currentLoopData = $storageLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($loc->id); ?>" data-store-id="<?php echo e($loc->store_id); ?>"><?php echo e($loc->name); ?> (<?php echo e($loc->store->name); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="status_id" class="form-select" required>
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>" <?php echo e(old('status_id') == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="row" id="price-fields-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="initial_price" id="initial_price" class="form-control" step="0.01" min="0" value="<?php echo e(old('initial_price')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Текущая цена (для продажи)</label>
                            <input type="number" name="current_price" id="current_price" class="form-control" step="0.01" min="0" value="<?php echo e(old('current_price')); ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="loan_amount" id="loan_amount" class="form-control" step="0.01" min="0" value="<?php echo e(old('loan_amount')); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Процент</label>
                            <input type="number" name="loan_percent" class="form-control" step="0.01" min="0" value="<?php echo e(old('loan_percent', 0)); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Дата займа *</label>
                            <input type="date" name="loan_date" class="form-control" value="<?php echo e(old('loan_date', date('Y-m-d'))); ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Срок залога до *</label>
                        <input type="date" name="expiry_date_pawn" class="form-control" value="<?php echo e(old('expiry_date_pawn')); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="seller_price" class="form-control" step="0.01" min="0" value="<?php echo e(old('seller_price')); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Комиссия %</label>
                            <input type="number" name="commission_percent" class="form-control" step="0.01" min="0" value="<?php echo e(old('commission_percent', 0)); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Срок до</label>
                            <input type="date" name="expiry_date_commission" class="form-control" value="<?php echo e(old('expiry_date_commission')); ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="purchase_amount" id="purchase_amount" class="form-control" step="0.01" min="0" value="<?php echo e(old('purchase_amount')); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Дата скупки *</label>
                            <input type="date" name="purchase_date" id="purchase_date" class="form-control" value="<?php echo e(old('purchase_date', date('Y-m-d'))); ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="mt-3">
    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-secondary">Отмена</a>
</div>
...
(function() {
    ...
    var categoriesData = <?php echo json_encode($categories->pluck('name', 'id'), 512) ?>;
    ...
    document.getElementById('btn-ai-estimate').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("accept.ai-estimate")); ?>', {
            method: 'POST',
            body: formData,
    ...
    function doRedemptionSearch() {
        ...
        var url = '<?php echo e(route("accept.redemption-search")); ?>?q=' + encodeURIComponent(q);
        fetch(url, {
            method: 'GET',
            ...
            .then(function(data) {
                ...
                clients.forEach(function(client) {
                    ...
                    contracts.forEach(function(contract) {
                        var redeemUrl = '<?php echo e(url("pawn-contracts")); ?>/' + contract.id + '/redeem?from=accept';
    ...
    if (redemptionListEl) {
        redemptionListEl.addEventListener('click', function(e) {
            ...
            tok.type = 'hidden';
            tok.name = '_token';
            tok.value = '<?php echo e(csrf_token()); ?>';
            f.appendChild(tok);
    ...
    passportParseBtn.addEventListener('click', function() {
        ...
        formData.append('_token', document.querySelector('input[name="_token"]').value);
        fetch('<?php echo e(route("accept.parse-passport")); ?>', {
            method: 'POST',
            body: formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/pawn-shop-mvp/resources/views/accept/create.blade.php ENDPATH**/ ?>