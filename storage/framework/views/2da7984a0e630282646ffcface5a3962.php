        ...
        <ul class="nav flex-column">
            <li>
                ...
                <ul class="nav flex-column collapse show nav-group-items" id="sidebar-group-clients">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('accept.create')); ?>"><i class="bi bi-plus-circle"></i> Приём товара</a></li>
                    <?php endif; ?>
                    <?php endif; ?>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('clients.index')); ?>"><i class="bi bi-people"></i> Клиенты</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('items.index')); ?>"><i class="bi bi-box-seam"></i> Товары</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('pawn-contracts.index')); ?>"><i class="bi bi-file-text"></i> Договоры залога</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('commission-contracts.index')); ?>"><i class="bi bi-file-earmark-text"></i> Договоры комиссии</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('purchase-contracts.index')); ?>"><i class="bi bi-cash-coin"></i> Договоры скупки</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('call-center.index')); ?>"><i class="bi bi-telephone-inbound"></i> Колл-центр</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="nav flex-column collapse show nav-group-items" id="sidebar-group-finance">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('cash.report')); ?>"><i class="bi bi-bar-chart"></i> Отчёт по кассам</a></li>
            ...
            <li>
                ...
                <ul class="nav flex-column collapse show nav-group-items" id="sidebar-group-settings">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('item-statuses.index')); ?>"><i class="bi bi-flag"></i> Статусы товара</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('storage-locations.index')); ?>"><i class="bi bi-geo-alt"></i> Места хранения</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('kb.index')); ?>"><i class="bi bi-journal-bookmark"></i> База знаний</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('profile.show')); ?>"><i class="bi bi-person"></i> Профиль</a></li>
                    <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isSuperAdmin()): ?>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('stores.index')); ?>"><i class="bi bi-shop"></i> Магазины</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('users.index')); ?>"><i class="bi bi-person-gear"></i> Пользователи</a></li>
                    <?php endif; ?>
                    <?php endif; ?>
                </ul>
            </li>
...
<?php /**PATH /Users/evgeny/pawn-shop-mvp/resources/views/layouts/app.blade.php ENDPATH**/ ?>