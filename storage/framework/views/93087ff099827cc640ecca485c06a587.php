        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('login')); ?>" class="btn">Вход для сотрудников</a>
...
<section id="documents" class="py-5">
    <div class="container-capital">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <a href="<?php echo e(route('kb.index')); ?>" class="text-decoration-none d-block h-100">
        ...
        <div class="d-flex flex-wrap gap-3 mt-3">
            <a href="<?php echo e(route('kb.index')); ?>" class="btn btn_blue"><i class="bi bi-journal-bookmark me-1"></i> Открыть базу знаний</a>
            <a href="<?php echo e(route('login')); ?>" class="btn">Вход для сотрудников</a>
        </div>
    </div>
</section>
...
<section id="contact" class="py-5" style="padding-bottom: 100px !important;">
    <div class="container-capital text-center">
        ...
        <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', config('services.lombard.phone'))); ?>" class="text-white fw-bold d-inline-block mb-4" style="font-size: 1.5rem;"><?php echo e(config('services.lombard.phone')); ?></a>
        <div class="mt-3">
            <a href="<?php echo e(route('login')); ?>" class="btn">Вход для сотрудников</a>
        </div>
    </div>
...
<?php echo $__env->make('landing.lombard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgeny/pawn-shop-mvp/resources/views/landing/lombard/index.blade.php ENDPATH**/ ?>