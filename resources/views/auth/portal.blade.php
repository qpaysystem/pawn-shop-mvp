...
<head>
    ...
    <title>Вход для сотрудников — {{ config('services.lombard.name', 'Ломбард') }}</title>
    ...
    <div class="portal-wrap">
        <aside class="portal-brand">
            <div class="portal-brand-logo">
                <a href="{{ route('home') }}">{{ config('services.lombard.name', 'Ломбард') }}</a>
            </div>
        ...
        <div class="portal-form-col">
            <a href="{{ route('home') }}" class="portal-back">
